...
#SBATCH -o /work/ymj1123ntu/logs/nt_genus_v12_258M-%j.out
#SBATCH -e /work/ymj1123ntu/logs/nt_genus_v12_258M-%j.err
...
CONFIG=${REPO}/configs/nt_token_genus_v12_258M.yaml
CKPT_DIR=/work/ymj1123ntu/checkpoints/nt_token_genus_v12_258M
...
if [ -f "${CKPT_DIR}/training_history.csv" ]; then
    ...
    if [ "${FINAL_EPOCH}" -ge "15" ]; then
        ...
        echo ">>> Resubmit: sbatch slurm/run_nt_genus_v12_258M_ddp_nano4.sh"
    fi
fi
echo "================================================================"
