...
#SBATCH --mem=256G
#SBATCH -t 48:00:00
#SBATCH -o slurm-dnabert_genus_50M-%j.out
#SBATCH -e slurm-dnabert_genus_50M-%j.err

# ============================================================
# DNABERT (overlapping 6-mer) — Genus @ 50M (scale-matched to NT-v2 v9)
# May need resume (see run_genus_v9_extend.sh pattern) if 48h runs out.
# ============================================================
...
echo "========================================="
echo "DNABERT — Genus (50M balanced reads)"
...
CONFIG="${REPO_DIR}/configs/dnabert_token_genus_50M.yaml"
RESULT_DIR="${REPO_DIR}/results/dnabert_token_genus_50M"
...
echo ""
echo "DNABERT 50M training + eval completed at: $(date)"
